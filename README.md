...
python train.py --output_dir ./outputs/{username}/{실험명} --do_train
```
...
# python train.py --output_dir ./outputs/{username}/train_dataset --model_name_or_path ./models/train_dataset/ --do_eval 
python train.py --output_dir ./outputs/{username}/eval_result --model_name_or_path ./outputs/{username}/{실험명} --do_eval 
```
...
python inference.py --output_dir ./outputs/{username}/pred_result/ --dataset_name ./data/test_dataset/ --model_name_or_path ./outputs/{username}/{실험명} --do_predict
```
