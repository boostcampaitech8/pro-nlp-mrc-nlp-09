...
def safe_normalize(text: str):
    """정답 span 손상 없이 매우 안전한 노이즈 제거 버전"""
...
def main():
    ...
    training_args.eval_steps = 500       # 500 step마다 EM/F1 계산
    training_args.save_strategy = "steps"
    training_args.save_steps = 500       # 500 step마다 체크포인트 저장
    ...
    datasets["train"] = normalize_split(datasets["train"])
    datasets["validation"] = normalize_split(datasets["validation"])
    # ===========================
    # 🔵 Normalize 적용
    # ===========================
    # ===========================
